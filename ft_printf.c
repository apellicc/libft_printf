...
/*   Updated: 2016/11/20 20:08:13 by apellicc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	ft_select_print(int *i, t_en *bin)
{
...
static void	ft_check(char *f, int *i, t_en *bin)
{
...
static void	ft_parse(char *f, t_en *bin)
{
	int		i;
